    ...
    <section className="flex flex-col gap-y-4 md:gap-y-8 text-textColor">
      <div className=" flex flex-row gap-5 justify-around">
        ...
        <div className="bg-[#e6f5eb] max-w-xs flex flex-col gap-y-4 px-6 py-3 rounded-lg border border-[#eef4f9] shadow">
          ...
          <p className="text-sm bg-white rounded-full px-3 py-2 font-medium flex justify-start shadow-md max-w-[130px] mx-auto cursor-pointer hover:shadow-lg">
            Add new house
          </p>
        </div>
      </div>
      ...
      <div className=" flex flex-col justify-center pb-5 mx-auto pt-7">
        ...
        <img src={dashboard} alt="See house listing" className=" md:max-w-md" />
      </div>
    </section>
  );
};
